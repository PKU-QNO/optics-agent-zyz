...
通过解析（半解析）论文复现，深入理解 Mie 散射的数学结构和物理图像，掌握检验模型正确性的系统方法，实践SPP课程学习的内容，为后续 COMSOL 数值计算的验证提供经过解析检验的基础模型和基准数据。
...
- 预计一周时间内至少完成前3篇论文, 进行一次汇报, 请老师点评指导, 检查我的工作方向和细节是否有问题
- 在第一次汇报时根据情况确认全部6篇论文完成时间
