...
public class FluidLaminarProbe {
  public static void main(String[] args) throws Exception {
    ...
    String selected = createFirstAvailablePhysics(model, "spf", new String[]{
      "LaminarFlow",
      "CreepingFlow"
    });
    ...
    writeMetrics("fluid-laminar-probe", "laminar_flow_or_creeping_flow", "completed", selected);
    if (args.length > 0) model.save(args[0]);
    System.out.println("FLUID_LAMINAR_PROBE_OK physics=" + selected);
  }
  ...
  private static String createFirstAvailablePhysics(Model model, String tag, String[] candidates) {
    ...
    throw new RuntimeException("No fluid candidate interface could be created: " + errors.toString());
  }
