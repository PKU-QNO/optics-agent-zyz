...
public class MieScatteringTimeDomain2DSmoke {
  public static void main(String[] args) throws Exception {
    runCase(
      "comsol-mie-td-smoke",
      "MIE_SCATTERING_TD_SMOKE_OK",
      4.0,
      0.55,
      1.60,
      0.20,
  ...
  private static CaseResult runCase(
    ...
    model.param().set("srcx", (-0.40 * domainSize) + "[um]");
    model.param().set("srcw", sourceWidth + "[um]");
    model.param().set("t0", "2.0");
    model.param().set("tau", "0.55");
    model.param().set("f0", "1.25");
    model.param().set("damp0", "0.18");
    model.param().set("abs_start", (0.36 * domainSize) + "[um]");
